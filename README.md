...
[![npm](https://img.shields.io/npm/l/node-media-server.svg)](LICENSE) [![Join the chat at https://gitter.im/Node-Media-Server/Lobby](https://badges.gitter.im/Node-Media-Server/Lobby.svg)](https://gitter.im/Node-Media-Server/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
